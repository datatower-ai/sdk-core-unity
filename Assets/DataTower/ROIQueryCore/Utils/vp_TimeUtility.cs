...
/////////////////////////////////////////////////////////////////////////////////
    public static class vp_TimeUtility
    {
	    ...
	    public static string TimeToString(float timeInSeconds, bool showHours, bool showMinutes, bool showSeconds,
            ...
            char delimiter = ':')
        {
            var iTime = TimeToUnits(timeInSeconds);

            var hours = iTime.hours < 10 ? "0" + iTime.hours : iTime.hours.ToString();
            var minutes = iTime.minutes < 10 ? "0" + iTime.minutes : iTime.minutes.ToString();
            var seconds = iTime.seconds < 10 ? "0" + iTime.seconds : iTime.seconds.ToString();
            var deciSeconds = iTime.deciSeconds.ToString();
            var centiSeconds = iTime.centiSeconds < 10 ? "0" + iTime.centiSeconds : iTime.centiSeconds.ToString();
            var milliSeconds = iTime.milliSeconds < 100 ? "0" + iTime.milliSeconds : iTime.milliSeconds.ToString();
	    ...
	    /// </summary>
	    public static string SystemTimeToString(DateTime systemTime, bool showHours, bool showMinutes, bool showSeconds,
            bool showTenths, bool showHundredths, bool showMilliSeconds,
            char delimiter = ':')
        {
        ...
        public static string SystemTimeToString(bool showHours, bool showMinutes, bool showSeconds,
            ...
            char delimiter = ':')
        {
            return SystemTimeToString(DateTime.Now, showHours, showMinutes, showSeconds, showTenths, showHundredths,
        ...
        public static Units SystemTimeToUnits(DateTime systemTime)
        {
            ...
            iTime.centiSeconds = systemTime.Millisecond / 10;
