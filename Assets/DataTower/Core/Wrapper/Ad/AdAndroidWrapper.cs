...
namespace DataTower.Core.Wrapper
{
    public partial class DTAdReportWrapper
    {
        ...
        //获取类，通过包名+类名方式
        private static readonly AndroidJavaClass DTAdReport = new AndroidJavaClass("ai.datatower.ad.DTAdReport");
        ...
        {
            return GetAndroidEnum("ai.datatower.ad.AdType", type.ToString());
        }


        private AndroidJavaObject GetPlatform(AdPlatform platform)
        {
            return GetAndroidEnum("ai.datatower.ad.AdPlatform", platform.ToString());
        }


        private AndroidJavaObject GetMediation(AdMediation mediation)
        {
            return GetAndroidEnum("ai.datatower.ad.AdMediation", mediation.ToString());
        }
        ...
        private void _reportPaid(string id, AdType type, string platform, string adgroupName,string adgroupType, string location, string seq,
            AdMediation mediation, string mediationId, double value, string currency, string precision,
