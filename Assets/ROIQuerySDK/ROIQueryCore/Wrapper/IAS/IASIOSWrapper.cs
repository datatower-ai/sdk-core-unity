...
namespace ROIQuery.Wrapper.IAS
{
...

    {
        ...
        private static extern void reportToShow(string iasSeq, string iasEntrance, string iasPlacement);
        ...
        [DllImport("__Internal")]
        private static extern void reportSubscribeFail(string iasSeq,string iasEntrance,string iasPlacement,string iasSku,string iasOrderId,string iasOriginalOrderId,string iasPrice,string iasCurrency,string iasCode,
        string iasMsg);
        ...
        private void _reportToShow(string seq, string placement, string entrance)
        {
            ...
            reportToShow(seq, entrance, placement);
        }
