...
namespace ROIQuery
{
    ...
    public class ROIQueryIASAPI
    {
        ...
        public static void ReportShowFail(string iasSeq, string iasPlacement, string iasCode, string iasMsg = "", string iasEntrance = "")
        {
            ROIQueryIASReportWrapper.Instace().ReportShowFail(iasSeq, iasPlacement, iasCode, iasMsg, iasEntrance);
        }

        public static void ReportSubscribe(string iasSeq, string iasPlacement, string iasSku, string iasOrderId, string iasPrice,
        string iasCurrency, string iasEntrance = "")
        {
            ROIQueryIASReportWrapper.Instace().ReportSubscribe(iasSeq, iasPlacement, iasSku, iasOrderId, iasPrice, iasCurrency, iasEntrance);
        }
        ...
        string iasCurrency, string iasEntrance = "")
        {
            ROIQueryIASReportWrapper.Instace().ReportSusbscribeSuccess(iasSeq, iasPlacement, iasSku, iasOrderId, iasOriginalOrderId, iasPrice,
        ...
        {
            ROIQueryIASReportWrapper.Instace().ReportSubscribeFail(iasSeq, iasPlacement, iasSku, iasOrderId, iasOriginalOrderId, iasPrice,
