...
namespace ROIQuery
{
    public partial class ROIQueryAnalyticsWrapper
    {
        ...
        //获取类，通过包名+类名方式
        private static readonly AndroidJavaClass DT = new AndroidJavaClass("com.roiquery.analytics.DT");

        private static readonly AndroidJavaClass DTAnalytics =
            new AndroidJavaClass("com.roiquery.analytics.DTAnalytics");
        ...
        private void _init()
        {
            ...
            //调用静态初始化方法 init
            DT.CallStatic("initSDK", currentContext, androidAppId, channel, isDebug, logLevel, jsonObject);
        }
